...
The Pyodide engines in src/python import numpy, pandas, and scipy, which are
supplied by the browser runtime rather than by this repo. When those are not
installed locally the import falls back to the static check, which is enough
for every rule except inherited __str__.
